...
- **`js/experiments/ph_v2/`**: الموديول البرمجي التفصيلي لتجربة pH بنمط Clean Architecture:
  ...
  - `soundManager.js`: تخليق المؤثرات الصوتية في الوقت الفعلي باستخدام Web Audio API بدون ملفات خارجية.
  - `app.js`: نقطة الانطلاق والتهيئة والتجميع لتجربة قياس الرقم الهيدروجيني.
